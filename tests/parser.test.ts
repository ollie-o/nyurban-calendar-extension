      ...
      expectedGames: [
        {
          ...
          location: 'AOS',
          description: 'Adolph Ochs School',
        },
        {
          gameNumber: 2,
        ...
        },
        {
          ...
          location: 'BRN-N',
          description: 'Brandeis H.S. (Near Court)',
        },
        {
          gameNumber: 4,
        ...
        },
        {
          ...
          location: 'LAG-F',
          description: 'LaGuardia H.S. (Far Court)',
        },
        {
          gameNumber: 6,
          opponent: 'Overcooked',
        ...
        },
        {
          ...
          location: 'JJC-A',
          description: 'John Jay College (Auxillary)',
        },
        {
          gameNumber: 9,
          ...
          location: 'LAG-N',
          description: 'LaGuardia H.S. (Near Court)',
        },
      ],
    },
    {
      ...
      expectedGames: [
        {
          ...
          location: 'JJC-N',
          description: 'John Jay College (Near Court)',
        },
        {
          gameNumber: 2,
        ...
        },
        {
          ...
          location: 'BRN-F',
          description: 'Brandeis H.S. (Far Court)',
        },
        {
          gameNumber: 4,
          opponent: 'OnlyMans',
        ...
        },
        {
          ...
          location: 'SJN',
          description: 'St. John Nepomucene',
        },
        {
          gameNumber: 7,
